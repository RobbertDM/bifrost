...
export default function Lineage() {
  ...
  const data_id_nodes = [
    ...
    { id: "root", label: "ingestion", size: 10 },
  ];
  ...
  const edges = [
    ...
    { id: "root1", source: "root", target: "project/wind", label: "" },
    {
      id: "e1-2",
      source: "project/mdm",
      target: "data_id/mdm_historic",
      label: "writes",
    }, // project writes data_id
    {
      id: "e1-3",
      source: "project/wind",
      target: "data_id/wind_forecast",
      label: "writes",
    }, // project writes data_id
    {
      id: "e1-4",
      source: "project/audit",
      target: "data_id/audit_log",
      label: "writes",
    }, // project writes data_id
    {
      id: "e1-5",
      source: "project/customer",
      target: "data_id/b2b_customers",
      label: "writes",
    }, // project writes data_id
    {
      id: "e1-6",
      source: "project/customer",
      target: "data_id/b2c_customers",
      label: "writes",
    }, // project writes data_id
    {
      id: "e2-0",
      source: "data_id/b2b_customers",
      target: "project/audit",
      label: "read by",
    }, // project reads data_id
    {
      id: "e2-1",
      source: "data_id/b2c_customers",
      target: "project/audit",
      label: "",
    }, // project reads data_id
    {
      id: "e2-2",
      source: "data_id/audit_log",
      target: "project/mdm",
      label: "",
    }, // project reads data_id
    {
